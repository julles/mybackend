        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="{{ Admin::assetAdmin() }}/#">See All Messages</a></li>
            </ul>
          </li>
          <!-- /.messages-menu -->
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="{{ Admin::assetAdmin() }}/#">View all</a></li>
            </ul>
          </li>
          <!-- Tasks Menu -->
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer">
                <a href="{{ Admin::assetAdmin() }}/#">View all tasks</a>
              </li>
            </ul>
          </li>
          <!-- User Account Menu -->
          <li class="dropdown user user-menu">
            ...
            <a href="{{ Admin::assetAdmin() }}/#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{ Admin::assetAdmin() }}/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="{{ Admin::assetAdmin() }}/#">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="{{ Admin::assetAdmin() }}/#">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="{{ Admin::assetAdmin() }}/#">Friends</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ Admin::assetAdmin() }}/#" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
